                ...
                <div class="dsmall-item side-nine">
                  <div class="detail-wrapper">
                    <div class="detail-block" data-aos="fade-up-cus">
                      <div class="pro-wrap">
                        <div class="pro-content">
                          <h1 class="detail-pro-name pro-name">CHIẾN BINH URI KẾT THÚC CHẶNG ĐUA CHUNG KẾT QUỐC TẾ TIMO 2023 VỚI KẾT QUẢ ẤN TƯỢNG</h1>
                        </div>
                      </div>
                    </div>
                    <div class="detail-block mona-content post-content" data-aos="fade-up-cus">
                      ...
                      <!-- <p>
                        🏆 𝐍𝐠𝐮𝐲𝐞̂̃𝐧 Đ𝐚̆𝐧𝐠 𝐒𝐚𝐧𝐠, 𝐋𝐨̛́𝐩 𝟐 𝐏𝐓𝐂𝐋𝐂𝐏𝐇 - 𝐇𝐮𝐲 𝐜𝐡𝐮̛𝐨̛𝐧𝐠 𝐕𝐚̀𝐧𝐠 <br />
                        🏆 𝐍𝐠𝐮𝐲𝐞̂̃𝐧 𝐇𝐮𝐲 𝐓𝐨𝐚̀𝐧, 𝐋𝐨̛́𝐩 𝟏 𝐓𝐢𝐞̂̉𝐮 𝐡𝐨̣𝐜 𝐓𝐡𝐮 𝐓𝐡𝐮𝐲̉ - 𝐇𝐮𝐲 𝐂𝐡𝐮̛𝐨̛𝐧𝐠 𝐕𝐚̀𝐧𝐠 <br />
                        🏆 Đ𝐚̣̆𝐧𝐠 𝐓𝐡𝐚́𝐢 𝐁𝐚́𝐜𝐡, 𝐋𝐨̛́𝐩 𝟏 𝐓𝐡𝐮̛̣𝐜 𝐡𝐚̀𝐧𝐡 𝐬𝐮̛ 𝐩𝐡𝐚̣𝐦 Đ𝐚̣𝐢 𝐡𝐨̣𝐜 𝐕𝐢𝐧𝐡 - 𝐇𝐮𝐲 𝐜𝐡𝐮̛𝐨̛𝐧𝐠 𝐕𝐚̀𝐧𝐠 <br />
                        🏅 𝐇𝐨𝐚̀𝐧𝐠 𝐍𝐠𝐡𝐢̃𝐚 𝐁𝐚́𝐜𝐡, 𝐋𝐨̛́𝐩 𝟓 𝐍𝐠𝐮𝐲𝐞̂̃𝐧 𝐓𝐫𝐚̉𝐢 - 𝐆𝐢𝐚̉𝐢 𝐤𝐡𝐮𝐲𝐞̂́𝐧 𝐤𝐡𝐢́𝐜𝐡
                      </p> -->
                      <p> 🏆 𝐍𝐠𝐮𝐲𝐞̂̃𝐧 Đ𝐚̆𝐧𝐠 𝐒𝐚𝐧𝐠, 𝐋𝐨̛́𝐩 𝟐 𝐏𝐓𝐂𝐋𝐂𝐏𝐇 - 𝐇𝐮𝐲 𝐜𝐡𝐮̛𝐨̛𝐧𝐠 𝐕𝐚̀𝐧𝐠 <br /></p>
                      <img
                        src="/images/post1/2.jpg"
                        alt=""
                      />

                      <p>  🏆 𝐍𝐠𝐮𝐲𝐞̂̃𝐧 𝐇𝐮𝐲 𝐓𝐨𝐚̀𝐧, 𝐋𝐨̛́𝐩 𝟏 𝐓𝐢𝐞̂̉𝐮 𝐡𝐨̣𝐜 𝐓𝐡𝐮 𝐓𝐡𝐮𝐲̉ - 𝐇𝐮𝐲 𝐂𝐡𝐮̛𝐨̛𝐧𝐠 𝐕𝐚̀𝐧𝐠 <br /></p>
                      <img
                        src="/images/post1/3.jpg"
                        alt=""
                      />

                      <p>  🏆 Đ𝐚̣̆𝐧𝐠 𝐓𝐡𝐚́𝐢 𝐁𝐚́𝐜𝐡, 𝐋𝐨̛́𝐩 𝟏 𝐓𝐡𝐮̛̣𝐜 𝐡𝐚̀𝐧𝐡 𝐬𝐮̛ 𝐩𝐡𝐚̣𝐦 Đ𝐚̣𝐢 𝐡𝐨̣𝐜 𝐕𝐢𝐧𝐡 - 𝐇𝐮𝐲 𝐜𝐡𝐮̛𝐨̛𝐧𝐠 𝐕𝐚̀𝐧𝐠 <br /></p>
                      <img
                        src="/images/post1/4.jpg"
                        alt=""
                      />

                      <p>  🏅 𝐇𝐨𝐚̀𝐧𝐠 𝐍𝐠𝐡𝐢̃𝐚 𝐁𝐚́𝐜𝐡, 𝐋𝐨̛́𝐩 𝟓 𝐍𝐠𝐮𝐲𝐞̂̃𝐧 𝐓𝐫𝐚̉𝐢 - 𝐆𝐢𝐚̉𝐢 𝐤𝐡𝐮𝐲𝐞̂́𝐧 𝐤𝐡𝐢́𝐜𝐡 <br /></p>
                      <img
                        src="/images/post1/5.jpg"
                        alt=""
                      />

                      <p>
                        Sau hơn 2 tháng phát động cuộc thi Toán TIMO đã thu hút được sự tham gia của đông đảo các bạn nhỏ và quý phụ huynh. Là sân
                        chơi trí tuệ mới lạ để các con thoả sức trải nghiệm, khám phá và chinh phục những tấm huy chương vàng Toán Quốc tế.
                      </p>
