                ...
                <div class="dsmall-item side-nine">
                  <div class="detail-wrapper">
                    <div class="detail-block" data-aos="fade-up-cus">
                      <div class="pro-wrap">
                        <div class="pro-content">
                          <h1 class="detail-pro-name pro-name">CÓ GÌ KHÁC BIỆT TRONG CHƯƠNG TRÌNH "HÀNH TRANG VÀO LỚP 1" CỦA URI</h1>
                        </div>
                      </div>
                    </div>
                    <div class="detail-block mona-content post-content" data-aos="fade-up-cus">
                      ...
                      <p>
                        𝗧𝗥𝗨𝗡𝗚 𝗧𝐀̂𝗠 𝗧𝗢𝗔́𝗡 𝗨𝗥𝗜 <br />
                        𝗦𝗼̂́ 𝟯/𝗔𝟮, 𝗛𝗲𝗿𝗺𝗮𝗻𝗻, 𝗛𝘂̛𝗻𝗴 𝗣𝗵𝘂́𝗰, 𝗧𝗣. 𝗩𝗶𝗻𝗵 <br />
                        ☎ 𝟬𝟴𝟴𝟲.𝟮𝟯𝟬.𝟴𝟴𝟴
                      </p>
                    </div>
                  </div>
                        ...
                        <div id="m_category_list-2" class="widget news-sidebar widget_m_category_list">
                          <div class="sidebar-block">
                            <div class="sidebar-head">
                              ...
                              /><noscript
                                ><img width="15" height="15" src="https://ischool.vn/template/assets/images/icon-dm.svg" alt="" class="icon"
                              /></noscript>
                    ...
                    <div class="side-open">
                      <div class="side-open-wrap">
                        <img
                          ...
                          data-lazy-src="https://ischool.vn/template/assets/images/icon-dm.svg"
                        /><noscript
                          ><img width="15" height="15" src="https://ischool.vn/template/assets/images/icon-dm.svg" class="icon" alt=""
                        /></noscript>
                      </div>
                    </div>
                          ...
                          <div v-for="i in 4" class="dsmall-item news-item">
                            <div class="news-wrap">
                              ...
                              <div class="news-content">
                                <a href="#" class="news-name"> Lịch nghỉ Tết Nguyên đán 2023 chính thức của học sinh 63 tỉnh thành </a>
                              </div>
                            </div>
                          </div>
                        </div>
